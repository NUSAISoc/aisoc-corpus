...
| Admin Shell Navigation     | Every admin route uses a dedicated menu for Graph and the three admin tools; tool pages include a return link to the admin home, and contributor bars display their normalized ranking score. | 2026-08-08 | —                                                                                       |
