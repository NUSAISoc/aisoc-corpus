...
| **Verification & CI** | Pull Request checks, LaTeX compile syntax checkers, link and citation validators, review checklists. | Runtime pages, styles. | `scripts/validate-pr.sh` |
